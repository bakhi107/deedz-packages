...
contract DeedArtV6 {
    ...
    function render(Card memory c) external pure returns (string memory) {
        ...
        string memory color = c.lit ? "#CCFF00" : "#FF1833";
        string memory hotColor = c.lit ? "#F5FFD0" : "#FFE0E5";
        string memory title = c.lit ? "LIT DEED" : "DARK DEED";
        string memory status = c.lit ? "[STATUS: ONLINE &amp; EARNING]" : "[STATUS: DORMANT // SECURED IN WALLET]";
        string memory expiry = c.lit
        ...
        string memory attributes = string.concat(
            ...
            '"},{"trait_type":"status","value":"', c.lit ? "Lit" : "Dark",
